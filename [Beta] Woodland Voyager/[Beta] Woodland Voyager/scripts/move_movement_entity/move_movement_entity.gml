...
x += _x_speed;
				////IMPORTANT MAIN BLOCK FOR COLLISION DETECTION
					//applies logic to prevent us from getting stuck in walls and gaps when approaching and hitting collision object
